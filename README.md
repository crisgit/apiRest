...
<body>
  ...
  "properties" : {
    ...
    "status" : {
      "type" : "string",
      "description" : "status do usuário na loja",
        ...
        <nav id="scrollingNav">
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="Fashions"><a href="#api-Fashions">API Methods - Fashions</a></li>
                    <li data-group="Fashions" data-name="addFashion" class="">
                      <a href="#api-Fashions-addFashion">addFashion</a>
                    </li>
                    <li data-group="Fashions" data-name="updateFashion" class="">
                      <a href="#api-Fashions-updateFashion">updateFashion</a>
                    </li>
                  <li class="nav-header" data-group="Store"><a href="#api-Store">API Methods - Store</a></li>
                    <li data-group="Store" data-name="deleteFashion" class="">
                      <a href="#api-Store-deleteFashion">deleteFashion</a>
                    </li>
                    <li data-group="Store" data-name="deleteOrder" class="">
                      <a href="#api-Store-deleteOrder">deleteOrder</a>
                    </li>
                    <li data-group="Store" data-name="findFashionsByStatus" class="">
                      <a href="#api-Store-findFashionsByStatus">findFashionsByStatus</a>
                    </li>
                    <li data-group="Store" data-name="findFashionsByTags" class="">
                      <a href="#api-Store-findFashionsByTags">findFashionsByTags</a>
                    </li>
                    <li data-group="Store" data-name="getFashionById" class="">
                      <a href="#api-Store-getFashionById">getFashionById</a>
                    </li>
                    ...
                    <li data-group="Store" data-name="updateFashionWithForm" class="">
                      <a href="#api-Store-updateFashionWithForm">updateFashionWithForm</a>
                    </li>
                    <li data-group="Store" data-name="uploadFile" class="">
                      <a href="#api-Store-uploadFile">uploadFile</a>
                    </li>
      ...
      <div id="content">
        ...
        <div id="header">
          <div id="api-_">
            ...
            <hr>
            <div>Essa Api fornece o acesso aos usuários do sistema</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-Fashions">
                  <h1>Fashions</h1>
                    <div id="api-Fashions-addFashion">
                      <article id="api-Fashions-addFashion-0" data-group="User" data-name="addFashion" data-version="0">
                        <div class="pull-left">
                          <h1>addFashion</h1>
                          <p>Adiciona um novo usuário a sua loja virtual</p>
                        </div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Fashions-addFashion-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Fashions-addFashion-0-java">Java</a></li>
                          <li class=""><a href="#examples-Fashions-addFashion-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Fashions-addFashion-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Fashions-addFashion-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Fashions-addFashion-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Fashions-addFashion-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Fashions-addFashion-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Fashions-addFashion-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Fashions-addFashion-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Fashions-addFashion-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Fashions-addFashion-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://fashionstore.swagger.io/v2/"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Fashions-addFashion-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.FashionsApi;

import java.io.File;
import java.util.*;

public class FashionsApiExample {

    public static void main(String[] args) {
        ApiClient defaultClient = Configuration.getDefaultApiClient();
        
        // Configure OAuth2 access token for authorization: fashionstore_auth
        OAuth fashionstore_auth = (OAuth) defaultClient.getAuthentication("fashionstore_auth");
        fashionstore_auth.setAccessToken("YOUR ACCESS TOKEN");

        FashionsApi apiInstance = new FashionsApi();
        Fashion body = ; // Fashion | Objeto de usuário que precisa ser adicionado à loja
        try {
            apiInstance.addFashion(body);
        } catch (ApiException e) {
            System.err.println("Exception when calling FashionsApi#addFashion");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Fashions-addFashion-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.FashionsApi;
...
public class FashionsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Fashions-addFashion-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Fashions-addFashion-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];

// Configure OAuth2 access token for authorization: (authentication scheme: fashionstore_auth)
[apiConfig setAccessToken:@"YOUR_ACCESS_TOKEN"];

Fashion *body = ; // Objeto de usuário que precisa ser adicionado à loja

FashionsApi *apiInstance = [[FashionsApi alloc] init];

// Adiciona um novo usuário a sua loja virtual
[apiInstance addFashionWith:body
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Fashions-addFashion-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var ListaDeUsurios = require('lista_de_usurios');
var defaultClient = ListaDeUsurios.ApiClient.instance;

// Configure OAuth2 access token for authorization: fashionstore_auth
var fashionstore_auth = defaultClient.authentications['fashionstore_auth'];
fashionstore_auth.accessToken = "YOUR ACCESS TOKEN"

var api = new ListaDeUsurios.FashionsApi()

var body = ; // {Fashion} Objeto de usuário que precisa ser adicionado à loja
...
api.addFashion(body, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Fashions-addFashion-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Fashions-addFashion-0-csharp">
...
namespace Example
{
    public class addFashionExample
    {
        public void main()
        {
            ...
            var apiInstance = new FashionsApi();
            var body = new Fashion(); // Fashion | Objeto de usuário que precisa ser adicionado à loja
            ...
            {
                Debug.Print("Exception when calling FashionsApi.addFashion: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Fashions-addFashion-0-php">
...
$api_instance = new Swagger\Client\Api\FashionsApi();
$body = ; // Fashion | Objeto de usuário que precisa ser adicionado à loja

try {
    $api_instance->addFashion($body);
} catch (Exception $e) {
    echo 'Exception when calling FashionsApi->addFashion: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Fashions-addFashion-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::FashionsApi;

# Configure OAuth2 access token for authorization: fashionstore_auth
$WWW::SwaggerClient::Configuration::access_token = 'YOUR_ACCESS_TOKEN';

my $api_instance = WWW::SwaggerClient::FashionsApi->new();
my $body = WWW::SwaggerClient::Object::Fashion->new(); # Fashion | Objeto de usuário que precisa ser adicionado à loja

eval { 
    $api_instance->addFashion(body => $body);
};
if ($@) {
    warn "Exception when calling FashionsApi->addFashion: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Fashions-addFashion-0-python">
...
api_instance = swagger_client.FashionsApi()
body =  # Fashion | Objeto de usuário que precisa ser adicionado à loja

try: 
    # Adiciona um novo usuário a sua loja virtual
    api_instance.add_fashion(body)
except ApiException as e:
    print("Exception when calling FashionsApi->addFashion: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
$(document).ready(function() {
  ...
  "in" : "body",
  "name" : "body",
  "description" : "Objeto de usuário que precisa ser adicionado à loja",
  "required" : true,
  "schema" : {
    "$ref" : "#/definitions/Fashion"
  }
};
  ...
  var result = $('#d2e199_addFashion_body');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_addFashion_body"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 405 - Invalida entrada </h3>
                      ...
                      <hr>
                    <div id="api-Fashions-updateFashion">
                      <article id="api-Fashions-updateFashion-0" data-group="User" data-name="updateFashion" data-version="0">
                        <div class="pull-left">
                          <h1>updateFashion</h1>
                          <p>Atualiza um usuário existente</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Fashions-updateFashion-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Fashions-updateFashion-0-java">Java</a></li>
                          <li class=""><a href="#examples-Fashions-updateFashion-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Fashions-updateFashion-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Fashions-updateFashion-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Fashions-updateFashion-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Fashions-updateFashion-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Fashions-updateFashion-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Fashions-updateFashion-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Fashions-updateFashion-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Fashions-updateFashion-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Fashions-updateFashion-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT "https://fashionstore.swagger.io/v2/"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Fashions-updateFashion-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.FashionsApi;
...
public class FashionsApiExample {
    ...
    public static void main(String[] args) {
        ...
        Fashion body = ; // Fashion | Objeto de usuário que precisa ser adicionado à loja
        try {
            apiInstance.updateFashion(body);
        } catch (ApiException e) {
            System.err.println("Exception when calling FashionsApi#updateFashion");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Fashions-updateFashion-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.FashionsApi;
...
public class FashionsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Fashions-updateFashion-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Fashions-updateFashion-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance updateFashionWith:body
              completionHandler: ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            }
                            ...
                            <div class="tab-pane" id="examples-Fashions-updateFashion-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var ListaDeUsurios = require('lista_de_usurios');
var defaultClient = ListaDeUsurios.ApiClient.instance;
...
api.updateFashion(body, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Fashions-updateFashion-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Fashions-updateFashion-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class updateFashionExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling FashionsApi.updateFashion: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Fashions-updateFashion-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $api_instance->updateFashion($body);
} catch (Exception $e) {
    echo 'Exception when calling FashionsApi->updateFashion: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Fashions-updateFashion-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::FashionsApi;
...
eval { 
    $api_instance->updateFashion(body => $body);
};
if ($@) {
    warn "Exception when calling FashionsApi->updateFashion: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Fashions-updateFashion-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Atualiza um usuário existente
    api_instance.update_fashion(body)
except ApiException as e:
    print("Exception when calling FashionsApi->updateFashion: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_updateFashion_body');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_updateFashion_body"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <h3> Status: 404 - Usuário da loja não encontrado </h3>
                            ...
                            <h3> Status: 405 - Recurso não permitido </h3>
                ...
                <section id="api-Store">
                  <h1>Store</h1>
                    <div id="api-Store-deleteFashion">
                      <article id="api-Store-deleteFashion-0" data-group="User" data-name="deleteFashion" data-version="0">
                        <div class="pull-left">
                          <h1>deleteFashion</h1>
                          <p>Deleta um usuário da loja</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/store/{fashionId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Store-deleteFashion-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Store-deleteFashion-0-java">Java</a></li>
                          <li class=""><a href="#examples-Store-deleteFashion-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Store-deleteFashion-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Store-deleteFashion-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Store-deleteFashion-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Store-deleteFashion-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Store-deleteFashion-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Store-deleteFashion-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Store-deleteFashion-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Store-deleteFashion-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Store-deleteFashion-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE "https://fashionstore.swagger.io/v2/store/{fashionId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Store-deleteFashion-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
...
public class StoreApiExample {
    ...
    public static void main(String[] args) {
        ...
        Long fashionId = 789; // Long | Usuário id para deletar
        String apiKey = apiKey_example; // String | 
        try {
            apiInstance.deleteFashion(fashionId, apiKey);
        } catch (ApiException e) {
            System.err.println("Exception when calling StoreApi#deleteFashion");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Store-deleteFashion-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.StoreApi;
...
public class StoreApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Store-deleteFashion-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Store-deleteFashion-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];

// Configure OAuth2 access token for authorization: (authentication scheme: fashionstore_auth)
[apiConfig setAccessToken:@"YOUR_ACCESS_TOKEN"];

Long *fashionId = 789; // Usuário id para deletar
String *apiKey = apiKey_example; //  (optional)

StoreApi *apiInstance = [[StoreApi alloc] init];

// Deleta um usuário da loja
[apiInstance deleteFashionWith:fashionId
    apiKey:apiKey
              completionHandler: ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            ...
                            <div class="tab-pane" id="examples-Store-deleteFashion-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var ListaDeUsurios = require('lista_de_usurios');
var defaultClient = ListaDeUsurios.ApiClient.instance;
...
var api = new ListaDeUsurios.StoreApi()

var fashionId = 789; // {Long} Usuário id para deletar
...
api.deleteFashion(fashionId, opts, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Store-deleteFashion-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Store-deleteFashion-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class deleteFashionExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling StoreApi.deleteFashion: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Store-deleteFashion-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
$fashionId = 789; // Long | Usuário id para deletar
$apiKey = apiKey_example; // String | 

try {
    $api_instance->deleteFashion($fashionId, $apiKey);
} catch (Exception $e) {
    echo 'Exception when calling StoreApi->deleteFashion: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Store-deleteFashion-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
...
my $fashionId = 789; # Long | Usuário id para deletar
my $apiKey = apiKey_example; # String | 

eval { 
    $api_instance->deleteFashion(fashionId => $fashionId, apiKey => $apiKey);
};
if ($@) {
    warn "Exception when calling StoreApi->deleteFashion: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Store-deleteFashion-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Deleta um usuário da loja
    api_instance.delete_fashion(fashionId, apiKey=apiKey)
except ApiException as e:
    print("Exception when calling StoreApi->deleteFashion: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <tr><td style="width:150px;">fashionId*</td>
<td>


    <div id="d2e199_deleteFashion_fashionId">
...
<td>
    ...
    <div id="d2e199_deleteFashion_apiKey">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 400 - ID inválido fornecido </h3>
                    ...
                    <div id="api-Store-deleteOrder">
                      <article id="api-Store-deleteOrder-0" data-group="User" data-name="deleteOrder" data-version="0">
                        <div class="pull-left">
                          <h1>deleteOrder</h1>
                          <p>Excluir pedido de compra por ID</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Para uma resposta válida, tente IDs inteiros com valor inteiro positivo. Valores negativos ou não inteiros geram erros de API</p>
                        <p></p>
                        <br />
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          ...
                          <li class=""><a href="#examples-Store-deleteOrder-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Store-deleteOrder-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Store-deleteOrder-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE "https://fashionstore.swagger.io/v2/store/order/{orderId}"</code></pre>
                          </div>
...
public class StoreApiExample {
    ...
    public static void main(String[] args) {
        ...
        StoreApi apiInstance = new StoreApi();
        Long orderId = 789; // Long | ID do pedido que precisa ser excluído
        try {
...
public class StoreApiExample {
  ...
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
                            ...
                            <div class="tab-pane" id="examples-Store-deleteOrder-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Long *orderId = 789; // ID do pedido que precisa ser excluído

StoreApi *apiInstance = [[StoreApi alloc] init];

// Excluir pedido de compra por ID
...
var orderId = 789; // {Long} ID do pedido que precisa ser excluído
...
$api_instance = new Swagger\Client\Api\StoreApi();
$orderId = 789; // Long | ID do pedido que precisa ser excluído
...
my $api_instance = WWW::SwaggerClient::StoreApi->new();
my $orderId = 789; # Long | ID do pedido que precisa ser excluído
...
<td>
    ...
    <div id="d2e199_deleteOrder_orderId">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Long
                    ...
                    <div class="inner description">
                        ID do pedido que precisa ser excluído
                    </div>
            </div>
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 400 - ID fornecido inválido </h3>
                            ...
                            <h3> Status: 404 - Ordem de pedido não encontrada </h3>
                      ...
                      <hr>
                    <div id="api-Store-findFashionsByStatus">
                      <article id="api-Store-findFashionsByStatus-0" data-group="User" data-name="findFashionsByStatus" data-version="0">
                        <div class="pull-left">
                          <h1>findFashionsByStatus</h1>
                          <p>Localiza usuários por status</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Vários valores de status podem ser fornecidos com sequências de caracteres separadas por vírgula</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/store/findByStatus</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Store-findFashionsByStatus-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Store-findFashionsByStatus-0-java">Java</a></li>
                          <li class=""><a href="#examples-Store-findFashionsByStatus-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Store-findFashionsByStatus-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Store-findFashionsByStatus-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Store-findFashionsByStatus-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Store-findFashionsByStatus-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Store-findFashionsByStatus-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Store-findFashionsByStatus-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Store-findFashionsByStatus-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Store-findFashionsByStatus-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Store-findFashionsByStatus-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://fashionstore.swagger.io/v2/store/findByStatus?status="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Store-findFashionsByStatus-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.StoreApi;
...
public class StoreApiExample {
    ...
    public static void main(String[] args) {
        ...
        StoreApi apiInstance = new StoreApi();
        array[String] status = ; // array[String] | Valores de status que precisam ser considerados para o filtro
        try {
            array[Fashion] result = apiInstance.findFashionsByStatus(status);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling StoreApi#findFashionsByStatus");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Store-findFashionsByStatus-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.StoreApi;
...
public class StoreApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Store-findFashionsByStatus-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Store-findFashionsByStatus-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];

// Configure OAuth2 access token for authorization: (authentication scheme: fashionstore_auth)
[apiConfig setAccessToken:@"YOUR_ACCESS_TOKEN"];

array[String] *status = ; // Valores de status que precisam ser considerados para o filtro

StoreApi *apiInstance = [[StoreApi alloc] init];

// Localiza usuários por status
[apiInstance findFashionsByStatusWith:status
              completionHandler: ^(array[Fashion] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Store-findFashionsByStatus-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var ListaDeUsurios = require('lista_de_usurios');
var defaultClient = ListaDeUsurios.ApiClient.instance;
...
var status = ; // {array[String]} Valores de status que precisam ser considerados para o filtro
...
api.findFashionsByStatus(status, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Store-findFashionsByStatus-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Store-findFashionsByStatus-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class findFashionsByStatusExample
    {
        public void main()
        {
            ...
            var apiInstance = new StoreApi();
            var status = new array[String](); // array[String] | Valores de status que precisam ser considerados para o filtro
            ...
            {
                Debug.Print("Exception when calling StoreApi.findFashionsByStatus: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Store-findFashionsByStatus-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
$api_instance = new Swagger\Client\Api\StoreApi();
$status = ; // array[String] | Valores de status que precisam ser considerados para o filtro

try {
    $result = $api_instance->findFashionsByStatus($status);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling StoreApi->findFashionsByStatus: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Store-findFashionsByStatus-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::StoreApi;
...
my $api_instance = WWW::SwaggerClient::StoreApi->new();
my $status = []; # array[String] | Valores de status que precisam ser considerados para o filtro

eval { 
    my $result = $api_instance->findFashionsByStatus(status => $status);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling StoreApi->findFashionsByStatus: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Store-findFashionsByStatus-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Localiza usuários por status
    api_response = api_instance.find_fashions_by_status(status)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StoreApi->findFashionsByStatus: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_findFashionsByStatus_status">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    array[String]
                    ...
                    <div class="inner description">
                        Valores de status que precisam ser considerados para o filtro
                    </div>
            </div>
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - Operação com sucesso </h3>

                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-findFashionsByStatus-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-findFashionsByStatus-200-schema">
                                  <div id='responses-findFashionsByStatus-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  ...
  "schema" : {
    ...
    "items" : {
      "$ref" : "#/definitions/Fashion"
                                        ...
                                        $('#responses-findFashionsByStatus-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-findFashionsByStatus-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-findFashionsByStatus-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 400 - Solicitação Imprópria </h3>
                      ...
                      <hr>
                    <div id="api-Store-findFashionsByTags">
                      <article id="api-Store-findFashionsByTags-0" data-group="User" data-name="findFashionsByTags" data-version="0">
                        <div class="pull-left">
                          <h1>findFashionsByTags</h1>
                          <p>Localiza usuários fashion por tags</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Várias tags podem ser fornecidas com strings separadas por vírgulas. Use tag1, tag2, tag3 para teste.</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/store/findByTags</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Store-findFashionsByTags-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Store-findFashionsByTags-0-java">Java</a></li>
                          <li class=""><a href="#examples-Store-findFashionsByTags-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Store-findFashionsByTags-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Store-findFashionsByTags-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Store-findFashionsByTags-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Store-findFashionsByTags-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Store-findFashionsByTags-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Store-findFashionsByTags-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Store-findFashionsByTags-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Store-findFashionsByTags-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Store-findFashionsByTags-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://fashionstore.swagger.io/v2/store/findByTags?tags="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Store-findFashionsByTags-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.StoreApi;
...
public class StoreApiExample {
    ...
    public static void main(String[] args) {
        ...
        StoreApi apiInstance = new StoreApi();
        String tags = tags_example; // String | Tags to filter by
        try {
            array[Fashion] result = apiInstance.findFashionsByTags(tags);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling StoreApi#findFashionsByTags");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Store-findFashionsByTags-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.StoreApi;
...
public class StoreApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Store-findFashionsByTags-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Store-findFashionsByTags-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];

// Configure OAuth2 access token for authorization: (authentication scheme: fashionstore_auth)
[apiConfig setAccessToken:@"YOUR_ACCESS_TOKEN"];

String *tags = tags_example; // Tags to filter by

StoreApi *apiInstance = [[StoreApi alloc] init];

// Localiza usuários fashion por tags
[apiInstance findFashionsByTagsWith:tags
              completionHandler: ^(array[Fashion] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-Store-findFashionsByTags-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var ListaDeUsurios = require('lista_de_usurios');
var defaultClient = ListaDeUsurios.ApiClient.instance;
...
api.findFashionsByTags(tags, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Store-findFashionsByTags-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Store-findFashionsByTags-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class findFashionsByTagsExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling StoreApi.findFashionsByTags: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Store-findFashionsByTags-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->findFashionsByTags($tags);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling StoreApi->findFashionsByTags: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Store-findFashionsByTags-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::StoreApi;
...
my $api_instance = WWW::SwaggerClient::StoreApi->new();
my $tags = tags_example; # String | Tags to filter by

eval { 
    my $result = $api_instance->findFashionsByTags(tags => $tags);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling StoreApi->findFashionsByTags: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Store-findFashionsByTags-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Localiza usuários fashion por tags
    api_response = api_instance.find_fashions_by_tags(tags)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StoreApi->findFashionsByTags: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_findFashionsByTags_tags">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-findFashionsByTags-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-findFashionsByTags-200-schema">
                                  <div id='responses-findFashionsByTags-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Operação com sucesso",
  "schema" : {
    ...
    "items" : {
      "$ref" : "#/definitions/Fashion"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-findFashionsByTags-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-findFashionsByTags-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-findFashionsByTags-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 400 - Valor de tag inválida </h3>
                      ...
                      <hr>
                    <div id="api-Store-getFashionById">
                      <article id="api-Store-getFashionById-0" data-group="User" data-name="getFashionById" data-version="0">
                        <div class="pull-left">
                          <h1>getFashionById</h1>
                          <p>Localiza usuário fashion por ID</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Retorna um único usuário da loja fashion</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/store/{fashionId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Store-getFashionById-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Store-getFashionById-0-java">Java</a></li>
                          <li class=""><a href="#examples-Store-getFashionById-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Store-getFashionById-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Store-getFashionById-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Store-getFashionById-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Store-getFashionById-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Store-getFashionById-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Store-getFashionById-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Store-getFashionById-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Store-getFashionById-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Store-getFashionById-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "api_key: [[apiKey]]" "https://fashionstore.swagger.io/v2/store/{fashionId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Store-getFashionById-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.StoreApi;
...
public class StoreApiExample {
    ...
    public static void main(String[] args) {
        ...
        StoreApi apiInstance = new StoreApi();
        Long fashionId = 789; // Long | ID de usuário fashion para retornar
        try {
            Fashion result = apiInstance.getFashionById(fashionId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling StoreApi#getFashionById");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Store-getFashionById-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.StoreApi;
...
public class StoreApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Store-getFashionById-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Store-getFashionById-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
Long *fashionId = 789; // ID de usuário fashion para retornar

StoreApi *apiInstance = [[StoreApi alloc] init];

// Localiza usuário fashion por ID
[apiInstance getFashionByIdWith:fashionId
              completionHandler: ^(Fashion output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Store-getFashionById-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var ListaDeUsurios = require('lista_de_usurios');
var defaultClient = ListaDeUsurios.ApiClient.instance;
...
var fashionId = 789; // {Long} ID de usuário fashion para retornar
...
api.getFashionById(fashionId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Store-getFashionById-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Store-getFashionById-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class getFashionByIdExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling StoreApi.getFashionById: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Store-getFashionById-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
$api_instance = new Swagger\Client\Api\StoreApi();
$fashionId = 789; // Long | ID de usuário fashion para retornar

try {
    $result = $api_instance->getFashionById($fashionId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling StoreApi->getFashionById: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Store-getFashionById-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::StoreApi;
...
my $api_instance = WWW::SwaggerClient::StoreApi->new();
my $fashionId = 789; # Long | ID de usuário fashion para retornar

eval { 
    my $result = $api_instance->getFashionById(fashionId => $fashionId);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling StoreApi->getFashionById: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Store-getFashionById-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Localiza usuário fashion por ID
    api_response = api_instance.get_fashion_by_id(fashionId)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StoreApi->getFashionById: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_getFashionById_fashionId">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Long
                    ...
                    <div class="inner description">
                        ID de usuário fashion para retornar
                    </div>
            </div>
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-getFashionById-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-getFashionById-200-schema">
                                  <div id='responses-getFashionById-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Operação com sucesso",
  "schema" : {
    "$ref" : "#/definitions/Fashion"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getFashionById-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-getFashionById-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-getFashionById-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                    ...
                    <div id="api-Store-getInventory">
                      <article id="api-Store-getInventory-0" data-group="User" data-name="getInventory" data-version="0">
                        <div class="pull-left">
                          <h1>getInventory</h1>
                          <p>Retorna inventários de usuários da loja por status</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Retorna um mapa de códigos de status para quantidades</p>
                        <p></p>
                        <br />
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          ...
                          <li class=""><a href="#examples-Store-getInventory-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Store-getInventory-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Store-getInventory-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET -H "api_key: [[apiKey]]" "https://fashionstore.swagger.io/v2/store/inventory"</code></pre>
                          </div>
...
// Retorna inventários de usuários da loja por status
  ...
  "schema" : {
    ...
    "additionalProperties" : {
      ...
      "format" : "int32"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getInventory-200-schema-data').val(stringify(schema));
                    ...
                    <div id="api-Store-getOrderById">
                      <article id="api-Store-getOrderById-0" data-group="User" data-name="getOrderById" data-version="0">
                        <div class="pull-left">
                          <h1>getOrderById</h1>
                          <p>Encontrar ordem de compra por ID</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Para uma resposta válida, tente IDs inteiros com valor&gt; &#x3D; 1 e &lt;&#x3D; 10. Outros valores gerarão exceções</p>
                        <p></p>
                        <br />
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          ...
                          <li class=""><a href="#examples-Store-getOrderById-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Store-getOrderById-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Store-getOrderById-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://fashionstore.swagger.io/v2/store/order/{orderId}"</code></pre>
                          </div>
...
public class StoreApiExample {
    ...
    public static void main(String[] args) {
        ...
        StoreApi apiInstance = new StoreApi();
        Long orderId = 789; // Long | ID do produto que precisa ser buscado
        try {
...
public class StoreApiExample {
  ...
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
                            ...
                            <div class="tab-pane" id="examples-Store-getOrderById-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Long *orderId = 789; // ID do produto que precisa ser buscado

StoreApi *apiInstance = [[StoreApi alloc] init];

// Encontrar ordem de compra por ID
...
var orderId = 789; // {Long} ID do produto que precisa ser buscado
...
$api_instance = new Swagger\Client\Api\StoreApi();
$orderId = 789; // Long | ID do produto que precisa ser buscado
...
my $api_instance = WWW::SwaggerClient::StoreApi->new();
my $orderId = 789; # Long | ID do produto que precisa ser buscado
...
<td>
    ...
    <div id="d2e199_getOrderById_orderId">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Long
                    ...
                    <div class="inner description">
                        ID do produto que precisa ser buscado
                    </div>
            </div>
                <div class="inner required">
                    Required
  ...
  "schema" : {
    "$ref" : "#/definitions/Order"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getOrderById-200-schema-data').val(stringify(schema));
                            ...
                            <h3> Status: 404 - Ordem de compra não encontrada </h3>
                    ...
                    <div id="api-Store-placeOrder">
                      <article id="api-Store-placeOrder-0" data-group="User" data-name="placeOrder" data-version="0">
                        <div class="pull-left">
                          <h1>placeOrder</h1>
                          <p>Faça um pedido para o usuário</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          ...
                          <li class=""><a href="#examples-Store-placeOrder-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Store-placeOrder-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Store-placeOrder-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://fashionstore.swagger.io/v2/store/order"</code></pre>
                          </div>
...
public class StoreApiExample {
    ...
    public static void main(String[] args) {
        ...
        StoreApi apiInstance = new StoreApi();
        Order body = ; // Order | encomenda para comprar o produto
        try {
...
public class StoreApiExample {
  ...
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
                            ...
                            <div class="tab-pane" id="examples-Store-placeOrder-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Order *body = ; // encomenda para comprar o produto

StoreApi *apiInstance = [[StoreApi alloc] init];

// Faça um pedido para o usuário
...
var body = ; // {Order} encomenda para comprar o produto
...
namespace Example
{
    public class placeOrderExample
    {
        public void main()
        {
            ...
            var apiInstance = new StoreApi();
            var body = new Order(); // Order | encomenda para comprar o produto
...
$api_instance = new Swagger\Client\Api\StoreApi();
$body = ; // Order | encomenda para comprar o produto
...
my $api_instance = WWW::SwaggerClient::StoreApi->new();
my $body = WWW::SwaggerClient::Object::Order->new(); # Order | encomenda para comprar o produto
...
$(document).ready(function() {
  ...
  "in" : "body",
  "name" : "body",
  "description" : "encomenda para comprar o produto",
  "required" : true,
  "schema" : {
    "$ref" : "#/definitions/Order"
  }
...
<div id="d2e199_placeOrder_body"></div>
  ...
  "schema" : {
    "$ref" : "#/definitions/Order"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-placeOrder-200-schema-data').val(stringify(schema));
                            ...
                            <h3> Status: 400 - Ordem Inválida </h3>
                      ...
                      <hr>
                    <div id="api-Store-updateFashionWithForm">
                      <article id="api-Store-updateFashionWithForm-0" data-group="User" data-name="updateFashionWithForm" data-version="0">
                        <div class="pull-left">
                          <h1>updateFashionWithForm</h1>
                          <p>Atualiza um usuário na loja com dados de formulário</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/store/{fashionId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Store-updateFashionWithForm-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Store-updateFashionWithForm-0-java">Java</a></li>
                          <li class=""><a href="#examples-Store-updateFashionWithForm-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Store-updateFashionWithForm-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Store-updateFashionWithForm-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Store-updateFashionWithForm-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Store-updateFashionWithForm-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Store-updateFashionWithForm-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Store-updateFashionWithForm-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Store-updateFashionWithForm-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Store-updateFashionWithForm-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Store-updateFashionWithForm-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://fashionstore.swagger.io/v2/store/{fashionId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Store-updateFashionWithForm-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.StoreApi;
...
public class StoreApiExample {
    ...
    public static void main(String[] args) {
        ...
        StoreApi apiInstance = new StoreApi();
        Long fashionId = 789; // Long | ID do usuário da loja que precisa ser atualizado
        String name = name_example; // String | Nome atualizado do usuário da loja
        String status = status_example; // String | Status atualizado do usuário da loja
        try {
            apiInstance.updateFashionWithForm(fashionId, name, status);
        } catch (ApiException e) {
            System.err.println("Exception when calling StoreApi#updateFashionWithForm");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Store-updateFashionWithForm-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.StoreApi;
...
public class StoreApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Store-updateFashionWithForm-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Store-updateFashionWithForm-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];

// Configure OAuth2 access token for authorization: (authentication scheme: fashionstore_auth)
[apiConfig setAccessToken:@"YOUR_ACCESS_TOKEN"];

Long *fashionId = 789; // ID do usuário da loja que precisa ser atualizado
String *name = name_example; // Nome atualizado do usuário da loja (optional)
String *status = status_example; // Status atualizado do usuário da loja (optional)

StoreApi *apiInstance = [[StoreApi alloc] init];

// Atualiza um usuário na loja com dados de formulário
[apiInstance updateFashionWithFormWith:fashionId
    name:name
    status:status
              completionHandler: ^(NSError* error) {
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Store-updateFashionWithForm-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var ListaDeUsurios = require('lista_de_usurios');
var defaultClient = ListaDeUsurios.ApiClient.instance;
...
var fashionId = 789; // {Long} ID do usuário da loja que precisa ser atualizado

var opts = { 
  'name': name_example, // {String} Nome atualizado do usuário da loja
  'status': status_example // {String} Status atualizado do usuário da loja
};
...
api.updateFashionWithForm(fashionId, opts, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Store-updateFashionWithForm-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Store-updateFashionWithForm-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class updateFashionWithFormExample
    {
        public void main()
        {
            ...
            var apiInstance = new StoreApi();
            var fashionId = 789;  // Long | ID do usuário da loja que precisa ser atualizado
            var name = name_example;  // String | Nome atualizado do usuário da loja (optional) 
            var status = status_example;  // String | Status atualizado do usuário da loja (optional) 
            ...
            {
                Debug.Print("Exception when calling StoreApi.updateFashionWithForm: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Store-updateFashionWithForm-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
$api_instance = new Swagger\Client\Api\StoreApi();
$fashionId = 789; // Long | ID do usuário da loja que precisa ser atualizado
$name = name_example; // String | Nome atualizado do usuário da loja
$status = status_example; // String | Status atualizado do usuário da loja

try {
    $api_instance->updateFashionWithForm($fashionId, $name, $status);
} catch (Exception $e) {
    echo 'Exception when calling StoreApi->updateFashionWithForm: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Store-updateFashionWithForm-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::StoreApi;
...
my $api_instance = WWW::SwaggerClient::StoreApi->new();
my $fashionId = 789; # Long | ID do usuário da loja que precisa ser atualizado
my $name = name_example; # String | Nome atualizado do usuário da loja
my $status = status_example; # String | Status atualizado do usuário da loja

eval { 
    $api_instance->updateFashionWithForm(fashionId => $fashionId, name => $name, status => $status);
};
if ($@) {
    warn "Exception when calling StoreApi->updateFashionWithForm: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Store-updateFashionWithForm-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
api_instance = swagger_client.StoreApi()
fashionId = 789 # Long | ID do usuário da loja que precisa ser atualizado
name = name_example # String | Nome atualizado do usuário da loja (optional)
status = status_example # String | Status atualizado do usuário da loja (optional)

try: 
    # Atualiza um usuário na loja com dados de formulário
    api_instance.update_fashion_with_form(fashionId, name=name, status=status)
except ApiException as e:
    print("Exception when calling StoreApi->updateFashionWithForm: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_updateFashionWithForm_fashionId">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Long
                    ...
                    <div class="inner description">
                        ID do usuário da loja que precisa ser atualizado
                    </div>
            </div>
                <div class="inner required">
                    Required
...
<td>
    ...
    <div id="d2e199_updateFashionWithForm_name">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        Nome atualizado do usuário da loja
                    </div>
            </div>
        </div>
    </div>
...
<td>
    ...
    <div id="d2e199_updateFashionWithForm_status">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        Status atualizado do usuário da loja
                    </div>
            </div>
        </div>
    </div>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 405 - Entrada inválida </h3>
                      ...
                      <hr>
                    <div id="api-Store-uploadFile">
                      <article id="api-Store-uploadFile-0" data-group="User" data-name="uploadFile" data-version="0">
                        <div class="pull-left">
                          <h1>uploadFile</h1>
                          <p>Carrega uma imagem</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/store/{fashionId}/uploadImage</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Store-uploadFile-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Store-uploadFile-0-java">Java</a></li>
                          <li class=""><a href="#examples-Store-uploadFile-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Store-uploadFile-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Store-uploadFile-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Store-uploadFile-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Store-uploadFile-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Store-uploadFile-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Store-uploadFile-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Store-uploadFile-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Store-uploadFile-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Store-uploadFile-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://fashionstore.swagger.io/v2/store/{fashionId}/uploadImage"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Store-uploadFile-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.StoreApi;
...
public class StoreApiExample {
    ...
    public static void main(String[] args) {
        ...
        StoreApi apiInstance = new StoreApi();
        Long fashionId = 789; // Long | ID do usuário da loja para atualizar
        String additionalMetadata = additionalMetadata_example; // String | Dados adicionais para passar para o servidor
        File file = /path/to/file.txt; // File | Arquivo para upload
        try {
            ApiResponse result = apiInstance.uploadFile(fashionId, additionalMetadata, file);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling StoreApi#uploadFile");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Store-uploadFile-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.StoreApi;
...
public class StoreApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Store-uploadFile-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Store-uploadFile-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];

// Configure OAuth2 access token for authorization: (authentication scheme: fashionstore_auth)
[apiConfig setAccessToken:@"YOUR_ACCESS_TOKEN"];

Long *fashionId = 789; // ID do usuário da loja para atualizar
String *additionalMetadata = additionalMetadata_example; // Dados adicionais para passar para o servidor (optional)
File *file = /path/to/file.txt; // Arquivo para upload (optional)

StoreApi *apiInstance = [[StoreApi alloc] init];

// Carrega uma imagem
[apiInstance uploadFileWith:fashionId
    ...
    file:file
              completionHandler: ^(ApiResponse output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Store-uploadFile-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var ListaDeUsurios = require('lista_de_usurios');
var defaultClient = ListaDeUsurios.ApiClient.instance;
...
var fashionId = 789; // {Long} ID do usuário da loja para atualizar

var opts = { 
  'additionalMetadata': additionalMetadata_example, // {String} Dados adicionais para passar para o servidor
  'file': /path/to/file.txt // {File} Arquivo para upload
};
...
api.uploadFile(fashionId, opts, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Store-uploadFile-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Store-uploadFile-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class uploadFileExample
    {
        public void main()
        {
            ...
            var apiInstance = new StoreApi();
            var fashionId = 789;  // Long | ID do usuário da loja para atualizar
            var additionalMetadata = additionalMetadata_example;  // String | Dados adicionais para passar para o servidor (optional) 
            var file = new File(); // File | Arquivo para upload (optional) 
            ...
            {
                Debug.Print("Exception when calling StoreApi.uploadFile: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Store-uploadFile-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
$api_instance = new Swagger\Client\Api\StoreApi();
$fashionId = 789; // Long | ID do usuário da loja para atualizar
$additionalMetadata = additionalMetadata_example; // String | Dados adicionais para passar para o servidor
$file = /path/to/file.txt; // File | Arquivo para upload

try {
    $result = $api_instance->uploadFile($fashionId, $additionalMetadata, $file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling StoreApi->uploadFile: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Store-uploadFile-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::StoreApi;
...
my $api_instance = WWW::SwaggerClient::StoreApi->new();
my $fashionId = 789; # Long | ID do usuário da loja para atualizar
my $additionalMetadata = additionalMetadata_example; # String | Dados adicionais para passar para o servidor
my $file = /path/to/file.txt; # File | Arquivo para upload

eval { 
    my $result = $api_instance->uploadFile(fashionId => $fashionId, additionalMetadata => $additionalMetadata, file => $file);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling StoreApi->uploadFile: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Store-uploadFile-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
api_instance = swagger_client.StoreApi()
fashionId = 789 # Long | ID do usuário da loja para atualizar
additionalMetadata = additionalMetadata_example # String | Dados adicionais para passar para o servidor (optional)
file = /path/to/file.txt # File | Arquivo para upload (optional)

try: 
    # Carrega uma imagem
    api_response = api_instance.upload_file(fashionId, additionalMetadata=additionalMetadata, file=file)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StoreApi->uploadFile: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_uploadFile_fashionId">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Long
                    ...
                    <div class="inner description">
                        ID do usuário da loja para atualizar
                    </div>
            </div>
                <div class="inner required">
                    Required
...
<td>
    ...
    <div id="d2e199_uploadFile_additionalMetadata">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        Dados adicionais para passar para o servidor
                    </div>
            </div>
        </div>
    </div>
...
<td>
  ...
  "schema" : {
    "$ref" : "#/definitions/ApiResponse"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-uploadFile-200-schema-data').val(stringify(schema));
                  ...
                  <h1>User</h1>
                    <div id="api-User-createUser">
                      <article id="api-User-createUser-0" data-group="User" data-name="createUser" data-version="0">
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Isso só pode ser feito pelo usuário logado.</p>
                        <p></p>
                        <br />
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          ...
                          <li class=""><a href="#examples-User-createUser-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-User-createUser-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-User-createUser-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://fashionstore.swagger.io/v2/user"</code></pre>
                          </div>
...
public class UserApiExample {
    ...
    public static void main(String[] args) {
        ...
        User body = ; // User | Objeto do usuário criado
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-User-createUser-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.UserApi;
...
public class UserApiExample {
  ...
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
                            ...
                            <div class="tab-pane" id="examples-User-createUser-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">User *body = ; // Objeto do usuário criado
...
var api = new ListaDeUsurios.UserApi()

var body = ; // {User} Objeto do usuário criado
...
namespace Example
{
    public class createUserExample
    {
        public void main()
        {
            ...
            var body = new User(); // User | Objeto do usuário criado
...
$body = ; // User | Objeto do usuário criado
...
my $body = WWW::SwaggerClient::Object::User->new(); # User | Objeto do usuário criado
...
<div id="d2e199_createUser_body"></div>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: default - Operação com sucesso </h3>
                    ...
                    <div id="api-User-createUsersWithArrayInput">
                      <article id="api-User-createUsersWithArrayInput-0" data-group="User" data-name="createUsersWithArrayInput" data-version="0">
                        <div class="pull-left">
                          ...
                          <p>Cria uma lista de usuários através de matriz de entrada</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          ...
                          <li class=""><a href="#examples-User-createUsersWithArrayInput-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-User-createUsersWithArrayInput-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-User-createUsersWithArrayInput-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://fashionstore.swagger.io/v2/user/createWithArray"</code></pre>
                          </div>
...
public class UserApiExample {
    ...
    public static void main(String[] args) {
        ...
        UserApi apiInstance = new UserApi();
        array[User] body = ; // array[User] | Lista de objeto do usuário
        try {
...
public class UserApiExample {
  ...
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
                            ...
                            <div class="tab-pane" id="examples-User-createUsersWithArrayInput-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">array[User] *body = ; // Lista de objeto do usuário

UserApi *apiInstance = [[UserApi alloc] init];

// Cria uma lista de usuários através de matriz de entrada
...
var body = ; // {array[User]} Lista de objeto do usuário
...
namespace Example
{
    public class createUsersWithArrayInputExample
    {
        public void main()
        {
            ...
            var apiInstance = new UserApi();
            var body = new array[User](); // array[User] | Lista de objeto do usuário
...
$api_instance = new Swagger\Client\Api\UserApi();
$body = ; // array[User] | Lista de objeto do usuário
...
my $api_instance = WWW::SwaggerClient::UserApi->new();
my $body = [WWW::SwaggerClient::Object::array[User]->new()]; # array[User] | Lista de objeto do usuário
...
$(document).ready(function() {
  ...
  "in" : "body",
  "name" : "body",
  "description" : "Lista de objeto do usuário",
  "required" : true,
  "schema" : {
    "type" : "array",
    "items" : {
                    ...
                    <div id="api-User-createUsersWithListInput">
                      <article id="api-User-createUsersWithListInput-0" data-group="User" data-name="createUsersWithListInput" data-version="0">
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          ...
                          <li class=""><a href="#examples-User-createUsersWithListInput-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-User-createUsersWithListInput-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-User-createUsersWithListInput-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://fashionstore.swagger.io/v2/user/createWithList"</code></pre>
                          </div>
                    ...
                    <div id="api-User-deleteUser">
                      <article id="api-User-deleteUser-0" data-group="User" data-name="deleteUser" data-version="0">
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          ...
                          <li class=""><a href="#examples-User-deleteUser-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-User-deleteUser-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-User-deleteUser-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE "https://fashionstore.swagger.io/v2/user/{username}"</code></pre>
                          </div>
...
public class UserApiExample {
    ...
    public static void main(String[] args) {
        ...
        UserApi apiInstance = new UserApi();
        String username = username_example; // String | O nome que precisa ser excluído
        try {
...
public class UserApiExample {
  ...
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
                            ...
                            <div class="tab-pane" id="examples-User-deleteUser-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *username = username_example; // O nome que precisa ser excluído
...
var username = username_example; // {String} O nome que precisa ser excluído
...
$api_instance = new Swagger\Client\Api\UserApi();
$username = username_example; // String | O nome que precisa ser excluído
...
my $api_instance = WWW::SwaggerClient::UserApi->new();
my $username = username_example; # String | O nome que precisa ser excluído
...
<td>
    ...
    <div id="d2e199_deleteUser_username">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        O nome que precisa ser excluído
                    </div>
            </div>
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 400 - Nome de usuário inválido fornecido </h3>
                            ...
                            <h3> Status: 404 - Usuário não encontrado </h3>
                            ...
                            <h3> Status: 410 - Usuário foi intencionalmente removido </h3>
                    ...
                    <div id="api-User-getUserByName">
                      <article id="api-User-getUserByName-0" data-group="User" data-name="getUserByName" data-version="0">
                        <div class="pull-left">
                          <h1>getUserByName</h1>
                          <p>Obter usuário por nome de usuário</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          ...
                          <li class=""><a href="#examples-User-getUserByName-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-User-getUserByName-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-User-getUserByName-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://fashionstore.swagger.io/v2/user/{username}"</code></pre>
                          </div>
...
public class UserApiExample {
    ...
    public static void main(String[] args) {
        ...
        UserApi apiInstance = new UserApi();
        String username = username_example; // String | O nome que precisa ser buscado. Use user1 para teste.
        try {
...
public class UserApiExample {
  ...
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
                            ...
                            <div class="tab-pane" id="examples-User-getUserByName-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *username = username_example; // O nome que precisa ser buscado. Use user1 para teste.
...
var username = username_example; // {String} O nome que precisa ser buscado. Use user1 para teste.
...
$api_instance = new Swagger\Client\Api\UserApi();
$username = username_example; // String | O nome que precisa ser buscado. Use user1 para teste.
...
my $api_instance = WWW::SwaggerClient::UserApi->new();
my $username = username_example; # String | O nome que precisa ser buscado. Use user1 para teste.
...
<td>
    ...
    <div id="d2e199_getUserByName_username">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        O nome que precisa ser buscado. Use user1 para teste.
                    </div>
            </div>
                <div class="inner required">
                    Required
  ...
  "schema" : {
    "$ref" : "#/definitions/User"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-getUserByName-200-schema-data').val(stringify(schema));
                            ...
                            <h3> Status: 400 - Nome de usuário fornecido é inválido </h3>
                    ...
                    <div id="api-User-loginUser">
                      <article id="api-User-loginUser-0" data-group="User" data-name="loginUser" data-version="0">
                        <div class="pull-left">
                          <h1>loginUser</h1>
                          <p>Registra o usuário no sistema</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          ...
                          <li class=""><a href="#examples-User-loginUser-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-User-loginUser-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-User-loginUser-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://fashionstore.swagger.io/v2/user/login?username=&password="</code></pre>
                          </div>
...
public class UserApiExample {
    ...
    public static void main(String[] args) {
        ...
        UserApi apiInstance = new UserApi();
        String username = username_example; // String | O nome de usuário para login
        String password = password_example; // String | A senha para login em texto claro
        try {
...
public class UserApiExample {
  ...
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
                            ...
                            <div class="tab-pane" id="examples-User-loginUser-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *username = username_example; // O nome de usuário para login
String *password = password_example; // A senha para login em texto claro
...
var username = username_example; // {String} O nome de usuário para login

var password = password_example; // {String} A senha para login em texto claro
...
$api_instance = new Swagger\Client\Api\UserApi();
$username = username_example; // String | O nome de usuário para login
$password = password_example; // String | A senha para login em texto claro
...
my $api_instance = WWW::SwaggerClient::UserApi->new();
my $username = username_example; # String | O nome de usuário para login
my $password = password_example; # String | A senha para login em texto claro
...
<td>
    ...
    <div id="d2e199_loginUser_username">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
...
<td>
    ...
    <div id="d2e199_loginUser_password">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        A senha para login em texto claro
                    </div>
            </div>
                <div class="inner required">
                    Required
  ...
  "headers" : {
    ...
    "X-Expires-After" : {
      ...
      "description" : "data em UTC quando o token expira"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-loginUser-200-schema-data').val(stringify(schema));
                                ...
                                <div class="tab-pane" id="responses-loginUser-200-headers">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>Integer</td>
                                            <td>int32</td>
                                            <td>chamadas por hora permitidas pelo usuário</td>
                                        </tr>
                                        <tr>
                                            <td>X-Expires-After</td>
                                            <td>Date</td>
                                            <td>date-time</td>
                                            <td>data em UTC quando o token expira</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>

                            <h3> Status: 400 - Nome de usuário / senha fornecida inválida </h3>
                    ...
                    <div id="api-User-logoutUser">
                      <article id="api-User-logoutUser-0" data-group="User" data-name="logoutUser" data-version="0">
                        <div class="pull-left">
                          <h1>logoutUser</h1>
                          <p>Sai da sessão do usuário logado atual</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          ...
                          <li class=""><a href="#examples-User-logoutUser-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-User-logoutUser-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-User-logoutUser-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://fashionstore.swagger.io/v2/user/logout"</code></pre>
                          </div>
...
// Sai da sessão do usuário logado atual
                    ...
                    <div id="api-User-updateUser">
                      <article id="api-User-updateUser-0" data-group="User" data-name="updateUser" data-version="0">
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          ...
                          <li class=""><a href="#examples-User-updateUser-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-User-updateUser-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-User-updateUser-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT "https://fashionstore.swagger.io/v2/user/{username}"</code></pre>
                          </div>
...
public class UserApiExample {
    ...
    public static void main(String[] args) {
        ...
        UserApi apiInstance = new UserApi();
        String username = username_example; // String | nome que precisa ser atualizado
        User body = ; // User | Objeto de usuário atualizado
        try {
...
public class UserApiExample {
  ...
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
                            ...
                            <div class="tab-pane" id="examples-User-updateUser-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *username = username_example; // nome que precisa ser atualizado
User *body = ; // Objeto de usuário atualizado
...
var username = username_example; // {String} nome que precisa ser atualizado

var body = ; // {User} Objeto de usuário atualizado
...
namespace Example
{
    public class updateUserExample
    {
        public void main()
        {
            ...
            var apiInstance = new UserApi();
            var username = username_example;  // String | nome que precisa ser atualizado
            var body = new User(); // User | Objeto de usuário atualizado
...
$api_instance = new Swagger\Client\Api\UserApi();
$username = username_example; // String | nome que precisa ser atualizado
$body = ; // User | Objeto de usuário atualizado
...
my $api_instance = WWW::SwaggerClient::UserApi->new();
my $username = username_example; # String | nome que precisa ser atualizado
my $body = WWW::SwaggerClient::Object::User->new(); # User | Objeto de usuário atualizado
...
<td>
    ...
    <div id="d2e199_updateUser_username">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    <div class="inner description">
                        nome que precisa ser atualizado
                    </div>
            </div>
                <div class="inner required">
                    Required
...
<div id="d2e199_updateUser_body"></div>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 400 - Usuário fornecido é inválido </h3>
          ...
          <div id="footer">
            <div id="api-_footer">
              <p>Suggestions, contact, support and error reporting;
                  <div class="app-desc">Information URL: <a href="https://github.com/crisgit">https://github.com/crisgit</a></div>
          ...
          <div id="generator">
            <div class="content">
              Generated 2018-08-10T17:12:55.893Z
            </div>
          </div>
      </div>
    </div>
